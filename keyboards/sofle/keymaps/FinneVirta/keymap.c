...
[_LOWER] = LAYOUT(
  ...
  SE_AMPR,  SE_EXLM, SE_AT,   SE_LBRC, SE_RBRC, SE_PIPE,                         SE_QUES, KC_7,    KC_8,    KC_9,   SE_ASTR, SE_BSLS,
  _______,  SE_HASH, SE_DLR,  SE_LPRN, SE_RPRN, SE_QUOT ,                        SE_CIRC, KC_4,    KC_5,    KC_6,   SE_PLUS, SE_SLSH, 
  _______,  SE_LABK, SE_RABK, SE_LCBR, SE_RCBR, SE_DQUO, _______,       _______, KC_0, KC_1, KC_2, KC_3, SE_EQL, _______,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | LAt  | LCtl |LShift|      | Caps |-------.    ,-------| PgUp | Left | Down | Right| Bspc | Del  |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX, KC_CAPS,                       KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT,  KC_BSPC, KC_DEL,
  KC_REDO, KC_UNDO, KC_CUT, KC_COPY, KC_PASTE, XXXXXXX,  _______,       _______,  XXXXXXX, KC_LSTRT, XXXXXXX, KC_LEND,   XXXXXXX, _______,
                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
